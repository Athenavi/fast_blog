...
ROUTE_REGISTRY = [
    ...
    ("src.api.v1.advanced_features.nft", "/api/v1/nft", ["nft"], False),
    ...
    ("src.api.v1.advanced_features.websocket", "/api/v1/ws", ["websocket"], False),
    ...
    ("src.api.v1.content_management.form_builder", "/api/v1/form-management", ["form-builder"], False),
    ("src.api.v1.content_management.menu_management", "/api/v1/menu-management", ["menu-management"], False),
    ...
    ("src.api.v1.ecommerce.inventory_management", "/api/v1/shop", ["inventory-management"], False),
    ...
    ("src.api.v1.marketing.ad_management", "/api/v1/ad-management", ["ad-management"], False),
    ...
    ("src.api.v1.performance.cache_management", "/api/v1/caches", ["cache-management"], False),
    ...
    ("src.api.v1.seo.seo_management", "/api/v1/seo-management", ["seo-management"], False),
    ...
    ("src.api.v1.system.webhook_management", "/api/v1/webhook", ["webhook-management"], False),
    ...
    ("src.api.v1.themes.theme_management", "/api/v1/theme-management", ["theme-management"], False),
    ...
    ("src.api.v1.users.user_management", "/api/v1/user-management", ["user-management"], False),
