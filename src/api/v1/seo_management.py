...
from shared.services.seo_analyzer import seo_analyzer
...
@router.get("/examples", summary="使用示例", description="获取SEO分析使用示例")
...
{
  "title": "Python编程入门教程 - 从零开始学习Python",
  "description": "完整的Python编程入门教程，涵盖基础语法、数据结构、面向对象等核心概念。适合零基础学习者，通过实例快速掌握Python编程技能。",
  "content": "Python是一种广泛使用的高级编程语言...",
  "keywords": ["Python", "编程", "教程"],
  "h1_headings": ["Python编程入门教程"],
  "h2_headings": ["Python简介", "安装Python", "基础语法"],
  "h3_headings": ["变量和数据类型", "控制流", "函数"],
  "images": [
    {"src": "/images/python-logo.png", "alt": "Python标志"},
    {"src": "/images/code-example.png", "alt": "代码示例"}
  ],
  "internal_links": 5
}
            '''.strip()
        ...
        "quick_check": {
            'description': '快速检查',
            'example': '''
GET /api/v1/seo/quick-check?title=Python教程&description=学习Python编程
            '''.strip()
        },
        "integration_tips": {
            'description': '集成建议',
        ...
        "real_time_feedback": {
            ...
            'code_example': '''
// React组件示例
function SEOChecker({ article }) {
  const [analysis, setAnalysis] = useState(null);
  
  useEffect(() => {
    if (article.title && article.content) {
      fetch('/api/v1/seo/analyze', {
        method: 'POST',
  ...
  return (
    <div className="seo-checker">
      <div className="score">
        <h3>SEO评分: {analysis.overall_score}/100</h3>
        <span className="grade">{analysis.grade}</span>
      </div>
