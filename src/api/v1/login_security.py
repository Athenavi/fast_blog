...
async def get_my_login_history(
    ...
    """
    try:
        history = login_security_service.get_login_history(current_user.id, limit=limit)
...
async def get_my_security_stats(
    ...
    """
    try:
        stats = login_security_service.get_security_stats(current_user.id)
...
async def get_locked_users(
    ...
    """
    try:
        locked_users = login_security_service.get_locked_users()
...
@router.get("/admin/user-history/{user_id}", summary="查看用户登录历史")
async def admin_get_user_history(
    ...
    """
    try:
        history = login_security_service.get_login_history(user_id, limit=limit)
...
@router.get("/admin/user-stats/{user_id}", summary="查看用户安全统计")
async def admin_get_user_stats(
    ...
    """
    try:
        stats = login_security_service.get_security_stats(user_id)
