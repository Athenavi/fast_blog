...
# 按顺序包含子路由
router.include_router(notifications_router, prefix="/notifications")  # /notifications/* - 主要通知功能
router.include_router(email_service_router, prefix="")  # 邮件服务
router.include_router(push_notifications_router, prefix="")  # 推送通知
