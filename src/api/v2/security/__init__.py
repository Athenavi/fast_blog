...
router.include_router(audit_log_router, prefix="")  # 审计日志
router.include_router(login_security_router, prefix="")  # 登录安全
router.include_router(rate_limit_router, prefix="")  # 速率限制
router.include_router(rbac_router, prefix="")  # RBAC权限
router.include_router(security_alert_router, prefix="")  # 安全警报
router.include_router(security_report_router, prefix="")  # 安全报告
