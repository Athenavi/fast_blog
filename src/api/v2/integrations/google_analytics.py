...
async def get_ga_config(
    ...
    if not config:
        return ok(
            data=None,
            msg="No Google Analytics configuration found"
        )
...
async def create_ga_config(
    ...
    return ok(
        ...
        msg="Google Analytics configuration created successfully"
    )
...
async def update_ga_config(
    ...
    return ok(
        ...
        msg="Google Analytics configuration updated successfully"
    )
...
async def deactivate_ga_config(
    ...
    return ok(
        msg="Google Analytics configuration deactivated successfully"
    )
...
async def get_tracking_code(
    ...
    if not config or not config.is_active:
        return ok(
            data={'tracking_code': ''},
            msg="Google Analytics is not configured or inactive"
        )
