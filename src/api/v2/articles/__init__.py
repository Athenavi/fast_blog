...
router.include_router(article_revisions_router, prefix="")  # 文章修订
...
router.include_router(article_annotations_router, prefix="/article-annotations")  # /article-annotations/*
