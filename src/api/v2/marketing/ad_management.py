...
def update_ad_placement(
    ...
    return ok(data={"id": updated.id}, msg="广告位更新成功")
...
def create_ad(
    ...
    return ok(data={"id": new_ad.id}, msg="广告创建成功")
...
def update_ad(
    ...
    return ok(data={"id": updated.id}, msg="广告更新成功")
...
def record_ad_click(
    ...
    return ok(data={"click_id": click.id}, msg="点击已记录")
