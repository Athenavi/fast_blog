...
async def record_performance(
    ...
    """记录性能数据"""
    performance_metrics = {'loadTime': load_time, 'domContentLoaded': dom_content_loaded}
    ...
    return ok(data={'recorded': True}, message="Performance data recorded")
...
async def get_slowest_pages(
    ...
    return ok(data={'pages': pages, 'count': len(pages)})
...
async def get_performance_trends(
    ...
    return ok(data={'url': url, 'trends': trends})
