...
# 按顺序包含子路由
router.include_router(membership_router, prefix="/membership")  # /membership/*
router.include_router(edge_functions_router, prefix="/edge—func")  # /edge—func/*
router.include_router(achievement_badges_router, prefix="/ext/badges")  # /ext/badges/*
router.include_router(ai_recommendations_router, prefix="/ext/ai-recommendations")  # /ext/ai-recommendations/*
router.include_router(expert_certification_router, prefix="/ext/expert-certification")  # /ext/expert-certification/*
router.include_router(nft_router, prefix="/ext/nft")  # /ext/nft/*
router.include_router(personalized_feed_router, prefix="/ext/personalized-feed")  # /ext/personalized-feed/*
router.include_router(points_system_router, prefix="/ext/point-system")  # /ext/point-system/*
router.include_router(recommendations_router, prefix="/ext/recommendations")  # /ext/recommendations/*
router.include_router(tipping_system_router, prefix="/ext/tipping-system")  # /ext/tipping-system/*
router.include_router(websocket_router, prefix="/ext/ws")  # /ext/ws/*
