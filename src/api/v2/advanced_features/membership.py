...
整合了原有的 vip.py �?membership.py 功能
"""
...
class CreatePaymentRequest(BaseModel):
    ...
    provider: Optional[str] = Field(None, description="支付服务商，�?alipay/wechat/stripe，为空则使用插件默认")
...
async def create_payment(
    ...
    if plugin:
        ...
        # 支付网关插件未安装，返回支付信息供前端自行处�?        return ok(data={
            'order_id': None,
            'payment_url': None,
            'provider': None,
