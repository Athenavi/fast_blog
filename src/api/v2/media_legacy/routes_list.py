...
async def list_media(
    ...
    folder_id: Optional[int] = Query(None, description="文件夹ID（直接指定）"),
    ...
    if folder_name:
        ...
        if path_parts:
            ...
            for i, part_name in enumerate(path_parts):
                ...
                folder_id_result = folder_result.scalar_one_or_none()
                ...
                if i == len(path_parts) - 1:
                    target_folder_id = folder_id_result
                else:
                    current_parent_id = folder_id_result
        ...
        # 如果没有指定 folder_name，使用 folder_id
