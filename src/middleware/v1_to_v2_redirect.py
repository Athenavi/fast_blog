...
class V1ToV2RedirectMiddleware(BaseHTTPMiddleware):
    ...
    def _find_redirect_target(self, v1_path: str) -> Optional[str]:
        ...
        module_prefixes = {
            ...
            '/api/v1/themes/': '/api/v2/themes/',
            '/api/v1/translations/': '/api/v2/translations/',
            '/api/v1/integrations/': '/api/v2/integrations/',
            '/api/v1/ads/': '/api/v2/ads/',
            '/api/v1/monitoring/': '/api/v2/monitoring/',
            '/api/v1/cache/': '/api/v2/cache/',
            '/api/v1/cdn/': '/api/v2/cdn/',
            '/api/v1/backup/': '/api/v2/backup/',
            '/api/v1/gdpr/': '/api/v2/gdpr/',
            '/api/v1/ext/': '/api/v2/ext/',
            '/api/v1/dashboard/': '/api/v2/dashboard/',
            '/api/v1/system/': '/api/v2/system/',
            '/api/v1/workflow/': '/api/v2/workflow/',
            '/api/v1/payments/': '/api/v2/payments/',
            '/api/v1/accessibility/': '/api/v2/accessibility/',
            '/api/v1/amp/': '/api/v2/amp/',
            '/api/v1/misc/': '/api/v2/misc/',
            '/api/v1/feed/': '/api/v2/feed/',
            '/api/v1/search/': '/api/v2/search/',
            '/api/v1/analytics/': '/api/v2/analytics/',
            '/api/v1/social/': '/api/v2/social/',
            '/api/v1/membership/': '/api/v2/membership/',
            '/api/v1/install/': '/api/v2/system/install/',
            '/api/v1/sites/': '/api/v2/sites/',
            '/api/v1/static-site/': '/api/v2/static-site/',
            '/api/v1/cms/': '/api/v2/cms/',
            '/api/v1/collaboration/': '/api/v2/collaboration/',
            '/api/v1/optimization/': '/api/v2/optimization/',
        }
