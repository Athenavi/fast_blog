...
interface MediaSelectorModalProps {
    ...
    mediaType?: 'all' | 'image' | 'video'; // 向后兼容的属性
}
...
const MediaSelectorModal: React.FC<MediaSelectorModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div
                className="rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col"
                                ...
                                >
                                    <div className="h-24 flex items-center justify-center bg-gray-50">
                                        {media.mime_type.startsWith('image/') || media.mime_type.startsWith('video/') ? (
                                            <img
                                                src={`${getConfig().API_BASE_URL}${getConfig().API_PREFIX}/thumbnail/?data=${media.hash}`}
