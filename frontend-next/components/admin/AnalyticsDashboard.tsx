...
export default function AnalyticsDashboard() {
    ...
    const fetchAnalyticsData = async () => {
        try {
            // 获取概览数据
            const overviewRes = await fetch('/api/v1/analytics/overview?days=30');
            ...
            // 获取趋势数据
            const trendRes = await fetch('/api/v1/analytics/article-views-trend?days=30');
            ...
            // 获取热门文章
            const popularRes = await fetch('/api/v1/analytics/popular-articles?limit=5&days=7');
    ...
    return (
        <div className="space-y-6 p-6">
            <div>
                ...
                <p className="text-muted-foreground">网站性能和用户行为分析</p>
            </div>
