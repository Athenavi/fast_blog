...
async def reorder_menu_items(
    ...
    try:
        ...
        await db.rollback()
        logger.exception("重新排序菜单项失败: %s", e)
        return False
