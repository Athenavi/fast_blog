...
const ArticleDetail: React.FC<Props> = ({
      ...
      >
        <div
          ...
          <div className="p-8 pb-6 text-center border-b border-gray-100 dark:border-gray-800">
            ...
            <h1 className="text-xl font-bold theme-text mb-1">需要密码访问</h1>
            <p className="text-sm theme-text-secondary">此文章已加密保护，请输入访问密码</p>
  ...
  if (error || !article) return (
      ...
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold theme-text mb-2">{error || '文章不存在'}</h1>
        <p className="theme-text-secondary mb-6">请检查链接是否正确，或浏览其他文章</p>
